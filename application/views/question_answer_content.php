...
function makerequest(given_value, objID)
 {
	//var obj = document.getElementById(objID);
        //alert(objID);
        serverPage='<?php echo base_url()?>welcome/blog_search/'+given_value;
        //alert(serverPage);
...
<section class="container">
    ...
    <div class="row">
        ...
        <article class="col-md-8 maincontent">
            <br />
            <br />
            <?php echo $question_answer_maincontent; ?>
        </article>
        <!-- /Article -->
        ...
        <aside class="col-md-4 sidebar sidebar-right">
            ...
            <?php
//            foreach ($all_published_blog_info as $v_blog) {
//                ?>
<!--                <ul>
                    <li><a href="//<?php //echo base_url(); ?>welcome/blogs.html"><?php //echo $v_blog->blog_title; ?> </a></li>
                </ul>-->
            <?php //} ?>
