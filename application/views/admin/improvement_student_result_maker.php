        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo base_url();?>super_admin/save_all_student_mark" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <h2><?php 
                    $improvement_student=array();
                    $f=0;
                    //for($f=0;;$f++){
                        foreach ($improvement_student_info_by_session as $v_improvement){
                            $improvement_student[$f++] = $v_improvement->student_id;
                       }
                    //}
//                       for($i=0;$i<$f;$i++){
//                           echo $improvement_student[$i];
//                       }
?></h2>
                    <h3>
                        <?php
                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable">
                        ...
                        <tbody>
                            ...
                            <?php foreach($student_info_by_session as $student_info){
                                $g=0;
                                for($i=0;$i<$f;$i++){
                                    if($student_info->student_id==$improvement_student[$i]){
                                        $g=1;
                                    }
                                }
