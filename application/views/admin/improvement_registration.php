...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo base_url();?>super_admin/save_improvement_registration" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <select name="student_id">
                                ...
                                <?php
                                foreach ($all_student_info as $v_info){    
                                ?>
                                <option value="<?php echo $v_info->student_id;?>"><?php echo $v_info->student_roll; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
