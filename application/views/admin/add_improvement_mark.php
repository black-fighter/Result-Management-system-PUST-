...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo base_url();?>super_admin/update_improvement_mark" method="post" enctype="multipart/form-data">
                <fieldset>
                    <legend>Add Improvement Mark</legend>
                    <h3>
                        <?php
                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable">
                        ...
                        <tbody>
                            <?php $i=0;?>
                            <?php foreach($improvement_student_info_by_session as $student_info){?>
                            <tr>
                                <td>
                                    ...
                                    <input type="hidden" class="span12 typeahead" name="data[<?php echo $i; ?>][subject_id]"  value="<?php echo $student_info->subject_id; ?>">
                                </td>
                                <td>
